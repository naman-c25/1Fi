...
import type { EmiPlanDTO } from "@/lib/types";
...
/**
 * The plan ladder from the brief: monthly amount x tenure on the left,
 * interest rate on the right, cashback underneath. Rendered as a radio group
 * so it is keyboard- and screen-reader-navigable.
 */
export function EmiPlanList({ plans, selectedPlanId, onSelect }: Props) {
  return (
    <div role="radiogroup" aria-label="EMI plans" className="flex flex-col gap-2">
      {plans.map((plan) => {
