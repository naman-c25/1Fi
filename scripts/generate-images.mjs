/**
 * Renders the product artwork referenced by the `variants[].images[].url`
 * fields in MongoDB.
 *
 * Generated as SVG rather than shipped as binaries so the repo stays small,
 * the images stay crisp at any size, and nothing hot-links to a CDN that could
 * vanish mid-demo.
 *
...
import { PRODUCTS, colorSlug } from "../server/src/seed-data.js";

const HERE = dirname(fileURLToPath(import.meta.url));
const OUT_DIR = join(HERE, "..", "client", "public", "images");
...
function cameraModule(style, body) {
...
function backView(product, colorName, bodyHex) {
...
function frontView(product, colorName, bodyHex, accentHex) {
...
async function main() {
  ...
  console.log(`Generated ${written} images into client/public/images`);
}
